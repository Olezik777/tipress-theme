...
add_action('init', function() {
	...
	// Popup strings
	pll_register_string('Получите консультацию врача', 'Получите консультацию врача', 'Popup');
	...
	pll_register_string('К сожалению, ничего не найдено по вашему запросу.', 'К сожалению, ничего не найдено по вашему запросу.', 'Search');
	pll_register_string('Попробуйте изменить поисковый запрос или использовать другие ключевые слова.', 'Попробуйте изменить поисковый запрос или использовать другие ключевые слова.', 'Search');
